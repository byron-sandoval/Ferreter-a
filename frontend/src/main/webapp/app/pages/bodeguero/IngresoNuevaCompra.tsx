...
import { faSave, faArrowLeft, faPlus, faTrash, faShoppingCart, faClipboardList, faPlusCircle, faBarcode, faBoxes, faBoxOpen } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p className="text-muted small m-0">
                        Ingrese facturas agrupando productos nuevos y ya existentes.
                    </p>
                </div>
                                    ...
                                    <div className="p-3 bg-light rounded border border-success border-opacity-25">
                                        <Row className="g-2">
                                            ...
                                            <Col md="4">
                                                ...
                                                <div className="input-group input-group-sm">
                                                    <span className="input-group-text bg-white"><FontAwesomeIcon icon={faBarcode} /></span>
                                                ...
                                                <div className="position-relative">
                                                    ...
                                                    {isCategoriaOpen && (
                                                        <div className="position-absolute w-100 shadow-lg border rounded bg-white mt-1 p-2" style={{ zIndex: 1050 }}>
                                                                ...
                                                                {categorias
                                                                    ...
                                                                    .map(c => (
                                                                        <div
                                                                            ...
                                                                            onClick={() => { setCategoriaId(c.id!.toString()); setIsCategoriaOpen(false); setSearchCategoriaTerm(''); }}
                                                                        >
                                                                            {c.nombre}
                                                                        </div>
                                                                    ))
                                                            ...
                                                            <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: -1 }} onClick={(e) => { e.stopPropagation(); setIsCategoriaOpen(false); }} />
                                                        </div>
                                                    )}
                                                </div>
                                            </Col>
                                                ...
                                                <div className="position-relative">
                                                    ...
                                                    {isUnidadOpen && (
                                                        <div className="position-absolute w-100 shadow-lg border rounded bg-white mt-1 p-2" style={{ zIndex: 1050 }}>
                                                                ...
                                                                {unidades
                                                                    ...
                                                                    .map(u => (
                                                                        <div
                                                                            ...
                                                                            className="p-2 border-bottom small product-item-hover-selector"
                                                                            style={{ cursor: 'pointer' }}
                                                                            onClick={() => { setUnidadId(u.id!.toString()); setIsUnidadOpen(false); setSearchUnidadTerm(''); }}
                                                                        >
                                                                            {u.nombre}
                                                                        </div>
                                                                    ))
                                                            ...
                                                            <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: -1 }} onClick={(e) => { e.stopPropagation(); setIsUnidadOpen(false); }} />
                                                        </div>
                                                    )}
                                                </div>
                                            </Col>
                                ...
                                <Table responsive size="sm" hover className="mt-4 border">
                                    ...
                                    <tbody>
                                        {detalles.length > 0 ? (
                                            detalles.map((d, index) => (
                                                <tr key={index} className="align-middle">
                                                    ...
                                                    <td className="text-center">
                                                        <Badge color="secondary" pill bg="light" className="text-dark border">{d.cantidad}</Badge>
                                                    </td>
                                            ...
                                            <tr><td colSpan={(isAdmin || isJefeBodega) ? 6 : 5} className="text-center py-4 text-muted fst-italic">No hay productos añadidos a esta factura.</td></tr>
                                        )}
                                    </tbody>
                                </Table>
                            </CardBody>
