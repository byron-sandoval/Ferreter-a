...
public class EmpresaResource {
    ...
    public ResponseEntity<EmpresaDTO> createEmpresa(@Valid @RequestBody EmpresaDTO empresaDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/empresas/" + empresaDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, empresaDTO.getId().toString()))
            .body(empresaDTO);
    }
    ...
    public ResponseEntity<EmpresaDTO> updateEmpresa(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, empresaDTO.getId().toString()))
            .body(empresaDTO);
    }
