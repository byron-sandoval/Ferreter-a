...
import com.ferronica.app.security.*;
import com.ferronica.app.security.SecurityUtils;
import com.ferronica.app.security.oauth2.AudienceValidator;
import com.ferronica.app.security.oauth2.CustomClaimConverter;
...
public class SecurityConfiguration {
    ...
    JwtDecoder jwtDecoder(ClientRegistrationRepository clientRegistrationRepository,
        ...
        jwtDecoder.setClaimSetConverter(
                new CustomClaimConverter(clientRegistrationRepository.findByRegistrationId("oidc"),
