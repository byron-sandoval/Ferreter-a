...
public class VentaAsserts {
    ...
    public static void assertVentaUpdatableFieldsEquals(Venta expected, Venta actual) {
        assertThat(actual)
                ...
                .satisfies(a -> assertThat(a.getSubtotal()).as("check subtotal").usingComparator(bigDecimalCompareTo)
                        .isEqualTo(expected.getSubtotal()))
                .satisfies(a -> assertThat(a.getIva()).as("check iva").usingComparator(bigDecimalCompareTo)
                        .isEqualTo(expected.getIva()))
                .satisfies(a -> assertThat(a.getTotal()).as("check total").usingComparator(bigDecimalCompareTo)
                        .isEqualTo(expected.getTotal()))
                .satisfies(a -> assertThat(a.getTotalEnMonedaBase())
                        .as("check totalEnMonedaBase")
                        .usingComparator(bigDecimalCompareTo)
                        .isEqualTo(expected.getTotalEnMonedaBase()))
                .satisfies(
                        a -> assertThat(a.getMetodoPago()).as("check metodoPago").isEqualTo(expected.getMetodoPago()))
                ...
                .satisfies(a -> assertThat(a.getTipoCambioVenta())
    ...
    public static void assertVentaUpdatableRelationshipsEquals(Venta expected, Venta actual) {
        assertThat(actual)
                ...
                .satisfies(
                        a -> assertThat(a.getNumeracion()).as("check numeracion").isEqualTo(expected.getNumeracion()));
    }
}
